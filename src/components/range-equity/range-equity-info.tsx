...
const RangeEquityInfo = () => {
  return (
    <div className="info my-5 container mx-auto" style={{ maxWidth: "998px" }}>
      ...
      <p className="ml-1">
        This calculator allows the user to calculate range vs range equity in
        texas hold'em poker. Simulate different board runouts and hole cards,
        and learn how different ranges are affected.
      </p>
      <h5>Range</h5>
      <p className="ml-1">
      ...
      <p className="ml-1">
        ...
        good preflop equity, however this does not necessarily correspond to the
      ...
      <h5>Simulation</h5>
      <p className="ml-1">
        When the <i>simulate</i> button is clicked, the program will take in the
        range of all the defined players and randomly simulate matchups between
        combos from their ranges. This will allow the estimation of the equity
        of each player, as well as the probability of tying (splitting the pot)
        and the pot odds.
      </p>
      <p className="ml-1">
        If both hole cards are specified for any player, then the simulation
        will use the hole cards instead of the range.
      </p>
      <p className="ml-1">
      ...
      <p className="ml-1">
        If any player is unchecked, then that player will not be considered in
        the simulation.
      </p>
    </div>
  );
