...
const Report: React.FC<ReportProps> = ({ combosReport, equityReport }) => {
  return (
    <>
      ...
      <p className="pl-2 my-0">
        <strong>{combosReport.flop_combos_percent.toFixed(1)}%</strong> of Flop combos
      </p>
      ...
      <p className="pl-2 my-0">
        <strong>{combosReport.turn_combos_percent.toFixed(1)}%</strong> of Turn combos
      </p>
      <h4 className="mt-2 mb-1">River</h4>
      <p className="pl-2 my-0">
        <strong>{combosReport.river_combos}</strong> combos kept to Showdown
      </p>
      <p className="pl-2 my-0">
        <strong>{combosReport.river_combos_percent.toFixed(1)}%</strong> of River combos
      </p>
    </>
  );
};
