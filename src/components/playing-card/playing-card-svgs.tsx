...
export const SUIT_SVGS: { [key: string]: JSX.Element } = {
  d: <DIAMOND_SVG width={"1.2em"} style={{ fill: "#df0000", display: "block", margin: "auto" }} />,
  h: <HEART_SVG width={"1.2em"} style={{ fill: "#df0000", display: "block", margin: "auto" }} />,
  c: <CLUB_SVG width={"1.2em"} style={{ fill: "#000000", display: "block", margin: "auto" }} />,
  s: <SPADE_SVG width={"1.2em"} style={{ fill: "#000000", display: "block", margin: "auto" }} />,
};

export const RANK_SVGS: { [key: string]: JSX.Element } = {
  A: <ACE_SVG width={"1.2em"} style={{ display: "block", margin: "auto" }} />,
  K: <KING_SVG width={"1.2em"} style={{ display: "block", margin: "auto" }} />,
  Q: <QUEEN_SVG width={"1.2em"} style={{ display: "block", margin: "auto" }} />,
  J: <JACK_SVG width={"1.2em"} style={{ display: "block", margin: "auto" }} />,
  T: <TEN_SVG width={"1.2em"} style={{ display: "block", margin: "auto" }} />,
  "9": <NINE_SVG width={"1.2em"} style={{ display: "block", margin: "auto" }} />,
  "8": <EIGHT_SVG width={"1.2em"} style={{ display: "block", margin: "auto" }} />,
  "7": <SEVEN_SVG width={"1.2em"} style={{ display: "block", margin: "auto" }} />,
  "6": <SIX_SVG width={"1.2em"} style={{ display: "block", margin: "auto" }} />,
  "5": <FIVE_SVG width={"1.2em"} style={{ display: "block", margin: "auto" }} />,
  "4": <FOUR_SVG width={"1.2em"} style={{ display: "block", margin: "auto" }} />,
  "3": <THREE_SVG width={"1.2em"} style={{ display: "block", margin: "auto" }} />,
  "2": <TWO_SVG width={"1.2em"} style={{ display: "block", margin: "auto" }} />,
};
